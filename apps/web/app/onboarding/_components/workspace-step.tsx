    ...
    <div className="mx-auto grid max-w-[460px] gap-4">
      <OnboardingField label="Areas de practica iniciales">
        <div className="grid gap-3">
          <label className="flex w-fit items-center gap-2 rounded-xl border border-field-border bg-field px-3 py-2 text-xs text-field-foreground">
            <Checkbox
              checked={practiceAreasEnabled}
              className="size-3.5 rounded-[4px] border-field-border bg-field text-field-foreground data-[state=checked]:border-[var(--workspace-pill-selected)] data-[state=checked]:bg-[var(--workspace-pill-selected)] data-[state=checked]:text-[var(--workspace-pill-selected-foreground)]"
