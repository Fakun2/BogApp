    ...
    <div className="grid gap-6">
      <div className="rounded-2xl border border-border bg-secondary/70 p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-muted-foreground">
          El estudio quedo activo y tu usuario ya tiene acceso como owner.
        </p>
      </div>
      <div className="grid gap-3 text-sm md:grid-cols-2">
        <VisualTile label="ID del Estudio" value={result.tenantId} />
        <VisualTile label="ID del Usuario" value={result.userId} />
      </div>
    </div>
  );
}
