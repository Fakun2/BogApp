            ...
            <div className="grid gap-3">
              <div className="overflow-hidden rounded-2xl border border-border/40">
                ...
                {Array.from({ length: 4 }).map((_, index) => (
                  <div
                    className="grid h-14 grid-cols-[1fr_120px_120px_56px] gap-4 border-t border-border/30 px-4 py-3"
                    key={index}
                  >
                ...
                <Table>
                  <TableHeader className="bg-[color-mix(in_oklab,var(--muted)_28%,transparent)] [&_tr]:border-0">
                    <TableRow className="hover:bg-transparent">
                      ...
                      {canUpdate || canDelete ? (
                        <TableHead className="h-10 px-4 text-right text-sm font-medium text-foreground">
                          Acciones
                        </TableHead>
                      ) : null}
                    </TableRow>
