      ...
      <Table className="min-w-[520px]">
        <TableHeader className="bg-[color-mix(in_oklab,var(--muted)_28%,transparent)] [&_tr]:border-0">
          <TableRow className="hover:bg-transparent">
            <TableHead className="h-10 px-3 text-sm font-medium text-foreground">Gasto</TableHead>
            <TableHead className="h-10 px-3 text-sm font-medium text-foreground">Monto</TableHead>
