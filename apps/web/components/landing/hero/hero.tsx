...
const DashboardPreview = dynamic(
  () => import("./dashboard-preview").then((mod) => mod.DashboardPreview),
  {
    loading: () => (
      <div
        aria-hidden="true"
        className="lumina-hero-preview mx-auto min-h-[360px] rounded-[2rem] border border-border bg-card/55 shadow-[var(--landing-dashboard-shadow)] backdrop-blur-xl sm:min-h-[520px]"
      />
    )
  }
);
